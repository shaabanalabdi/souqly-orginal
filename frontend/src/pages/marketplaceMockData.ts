...
export const marketplaceListings: MarketplaceListing[] = [
  {
    id: 101,
    titleAr: 'تويوتا كامري 2022 بحالة ممتازة',
    titleEn: 'Toyota Camry 2022 in Excellent Condition',
    price: 82000,
    currency: 'SAR',
    locationAr: 'الرياض',
    locationEn: 'Riyadh',
  ...
  {
    id: 102,
    titleAr: 'شقة للإيجار قرب المترو',
    titleEn: 'Apartment for Rent Near Metro',
    price: 4500,
    currency: 'SAR',
    locationAr: 'دبي',
    locationEn: 'Dubai',
  ...
  {
    id: 103,
    titleAr: 'iPhone 15 Pro سعة 256GB',
...
export const listingAttributes = [
  ...
  { keyAr: 'الموديل', keyEn: 'Model', valueAr: '2022', valueEn: '2022' },
